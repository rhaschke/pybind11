...
static_assert(std::is_same<movable_cast_op_type<MoveOnlyInt>, MoveOnlyInt&&>::value, "only moving is supported");
...
static_assert(std::is_same<movable_cast_op_type<CopyOnlyInt>, CopyOnlyInt&>::value, "only copying is supported");
...
TEST_SUBMODULE(copy_move_policies, m) {
    ...
    py::class_<MoveOnlyIntC>(m, "MoveOnlyInt")
        ...
        .def_static("consume_copy", [](MoveOnlyIntC v) { return v.value; })
        .def_static("consume_move", [](MoveOnlyIntC&& v) { return v.value; })
        .def_static("consume_reference", [](const MoveOnlyIntC& v) { return v.value; })
        ;
    ...
    py::class_<MoveOrCopyIntC>(m, "MoveOrCopyInt")
        ...
        .def_static("consume_copy", [](MoveOrCopyIntC v) { return v.value; })
        .def_static("consume_move", [](MoveOrCopyIntC&& v) { return v.value; })
        .def_static("consume_reference", [](const MoveOrCopyIntC& v) { return v.value; })
        ;
    ...
    py::class_<CopyOnlyIntC>(m, "CopyOnlyInt")
        ...
        .def_static("consume_copy", [](CopyOnlyIntC v) { return v.value; })
        .def_static("consume_move", [](CopyOnlyIntC&& v) { return v.value; })
        .def_static("consume_reference", [](const CopyOnlyIntC& v) { return v.value; })
        ;
